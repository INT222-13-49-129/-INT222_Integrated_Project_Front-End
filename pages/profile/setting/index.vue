    ...
    <div class="bg-white min-h-full">
        ...
        <div class="flex xl:flex-row flex-col items-center justify-center xl:gap-x-20 gap-y-6 xl:mt-10 mt-16">
            <div class="xl:w-auto w-screen">
                ...
                <div
                    class="text-gray-700 xl:text-3xl text-2xl text-center xl:mt-2 bg-white"
                >{{ user.username }}</div>
            </div>
            <div class="xl:w-144 w-11/12 rounded-3xl filter drop-shadow-all bg-white shadow-md px-6 py-4">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex justify-between border-b-2 xl:py-3 py-2">
                        ...
                        <div class="text-gray-600 xl:text-base text-sm">{{ user.gender === 'M' ? 'Male' : 'Female' }}</div>
                    </div>
                    <div class="flex justify-between border-b-2 xl:py-3 py-2">
