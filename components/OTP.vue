        ...
        <div class="flex md:flex-row flex-col">
            ...
            <div class="md:pl-28 mx-auto md:mx-0">
                ...
                <div class="md:text-lg text-sm px-5 md:px-0 text-gray-400">
                    Enter the confirmation code sent to <span class="text-blue-600">{{ email }}</span>
                ...
                >
                    <span>
                        ไม่ได้ อีเมล ?
                        <span class="text-lightorange cursor-pointer" @click="$parent.otpresend()">ส่งรหัสอีกครั้ง?</span>
                    </span>
                    <button
